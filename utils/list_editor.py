...
class ListEditor:
    def __init__(self, parent, file_path, title, app=None):
        ...
        self.scale_factor = getattr(app, 'scale_factor', 1.0) if app else 1.0
        
        dialog_width = scale_size(600, self.scale_factor)
        dialog_height = scale_size(500, self.scale_factor)
        ...
        self.dialog.minsize(scale_size(500, self.scale_factor), scale_size(400, self.scale_factor))
        ...
        self.text_area = tk.Text(text_frame, wrap=tk.WORD, font=("Consolas", font_size_text), undo=True, height=20)
        ...
        self.search_next_btn = tk.Button(self.search_frame, text=tr('editor_find_next'), command=self.search_next, width=btn_width_search)
        if app:
        ...
        self.search_close_btn = tk.Button(self.search_frame, text=tr('editor_close'), command=self.toggle_search, width=btn_width_close)
        if app:
        ...
        self.save_btn = tk.Button(button_frame, text=tr('editor_save'), command=self.save_content, padx=btn_padx, pady=btn_pady, takefocus=True, **button_style)
        ...
        self.cancel_btn = tk.Button(button_frame, text=tr('editor_cancel'), command=self.dialog.destroy, padx=btn_padx, pady=btn_pady, takefocus=True, **cancel_style)

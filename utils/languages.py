...
class Languages:
    ...
    TRANSLATIONS = {
        'Russian': {
            ...
            'splash_trying_source': 'Пробуем другой источник: {source}',
            'splash_trying_zapret_source': 'Пробуем другой источник zapret: {source}',
        ...
        'English': {
            ...
            'splash_trying_source': 'Trying another source: {source}',
            'splash_trying_zapret_source': 'Trying source for zapret: {source}',

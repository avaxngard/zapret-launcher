...
class Languages:
    ...
    TRANSLATIONS = {
        'Russian': {
            ...
            'hosts_template_discord': 'Доступ к Discord',
            ...
            'dialog_settings_tgproxy': 'Настройки Telegram proxy',
            'dialog_settings_chooselang': 'Выбор языка',
            'dialog_settings_choosetheme': 'Выбор оформления',
            ...
            'settings_current_tg_secret': 'Ваш секрет-ключ:',
            'settings_autostart': 'Автозапуск',
            'settings_autostart_desc': 'Запуск лаунчера при старте Windows',
            'settings_search_dublicate': 'Поиск дубликатов',
            'settings_search_vpn': 'Поиск VPN-процессов',
            'settings_theme_desc': 'Сменить оформление лаунчера',
            'settings_language_desc': 'Сменить язык интерфейса',
        ...
        'English': {
            ...
            'hosts_template_discord': 'Access to Discord',
            ...
            'dialog_settings_tgproxy': 'Telegram proxy settings',
            'dialog_settings_chooselang': 'Choosing a language',
            'dialog_settings_choosetheme': 'Choosing a theme',
            ...
            'settings_reinstall_title': 'Core reinstall',
            ...
            'settings_language_desc': 'Change interface language',
